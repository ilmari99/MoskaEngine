...
def play_as_human(model_path = "./model.tflite",
                  pred_format="bitmap",
...
def play_standard_game():
    out = play_as_human(model_path=os.environ["MOSKA_ROOT_PATH"] + "/Models/Model-nn1-BB/model.tflite", pred_format="bitmap",test=False, all_against_human=False)
    return out

if __name__ == "__main__":
    start_time = time.time()
    play_as_human(model_path=os.environ["MOSKA_ROOT_PATH"] + "/Models/Model-nn1-BB/model.tflite", pred_format="bitmap",test=False, all_against_human=False)
